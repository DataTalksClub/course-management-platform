...
- [x] 2026-07-02: Remove single-use Datamailer outbox status query wrappers and
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Remove the single-use Datamailer recipient-list import job data
  wrapper and construct `ImportJobData` directly in the import-by-reference
  branch. Verification:
  `uv run ruff check course_management/datamailer/recipient_list_sync.py docs/refactoring-plan.md`,
  `python -m py_compile course_management/datamailer/recipient_list_sync.py`,
...
- [x] 2026-07-02: Remove single-use Datamailer score-notification submission
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Remove the single-use Datamailer project-passed candidate
  submission queryset wrapper and keep the named queryset next to the
  passed-member dedupe loop. Verification:
  `uv run ruff check course_management/datamailer/payloads/project_outcomes.py docs/refactoring-plan.md`,
  `python -m py_compile course_management/datamailer/payloads/project_outcomes.py`,
  `uv run python manage.py test courses.tests.test_datamailer_project_outcomes`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Remove the single-use Datamailer peer-review assignment
  submission queryset wrapper and keep the named queryset next to the
  notification-member dedupe loop. Verification:
  `uv run ruff check course_management/datamailer/payloads/peer_review_members.py docs/refactoring-plan.md`,
  `python -m py_compile course_management/datamailer/payloads/peer_review_members.py`,
  `uv run python manage.py test courses.tests.test_datamailer_peer_review`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
...
- [x] 2026-07-02: Remove the single-use Datamailer course-graduate source-object
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Remove the single-use Datamailer registration contact tag
  helper and keep the small course/tag decision inside the contact payload
  builder. Verification:
  `uv run ruff check course_management/datamailer/payloads/registration_contacts.py docs/refactoring-plan.md`,
  `python -m py_compile course_management/datamailer/payloads/registration_contacts.py`,
...
- [x] 2026-07-02: Remove the single-use API registration-campaign registrations
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Remove the single-use cadmin campaign-registration queryset
  wrapper and keep the base queryset in the registrations context-data builder.
  Verification:
  `uv run ruff check cadmin/views/campaign_registration_list.py docs/refactoring-plan.md`,
  `python -m py_compile cadmin/views/campaign_registration_list.py`,
...
- [x] 2026-07-02: Remove single-use cadmin enrollment-edit submission queryset
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Replace cadmin enrollment view-model pass-through predicates
  with standard `attrgetter` callables while keeping comparison predicates
  named. Verification:
  ...
  wrapper scan for the removed predicate helpers, `uvx pyrefly check`,
  repository AST cleanup scan excluding migrations
...
- [x] 2026-07-02: Remove single-use leaderboard export cache-key wrappers and
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Remove the single-use OpenAPI view callback wrapper and get the
  callback directly from the documented URL pattern during metadata inspection.
  Verification: `uv run ruff check api/openapi/spec.py docs/refactoring-plan.md`,
  `python -m py_compile api/openapi/spec.py`,
  `uv run python manage.py test api.tests.test_openapi`, wrapper scan for the
  removed helper, `uvx pyrefly check`, repository AST cleanup scan excluding
  migrations (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`,
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Remove the single-use project scoring success-message wrapper
  and keep the named success message inside the scoring flow. Verification:
  `uv run ruff check courses/project_scoring.py docs/refactoring-plan.md`,
  `python -m py_compile courses/project_scoring.py`,
  `uv run python manage.py test courses.tests.test_project_score api.tests.test_project_scoring`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
...
- [x] 2026-07-02: Removed local project-voting test mixins by folding the
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed project-list view test setup/request mixins into
  the focused `ProjectListViewTestBase`, and updated list and pagination tests
  to inherit from that base directly. Verification:
  `uv run python manage.py test courses.tests.test_project_list_view courses.tests.test_project_list_pagination`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
...
- [x] 2026-07-02: Removed the project deadline-reminder test mixin by moving
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Removed the homework deadline-reminder test mixin by moving
  homework reminder fixtures, payload assertions, and audit assertions to
...
- [x] 2026-07-02: Removed homework submission-confirmation helper mixins by
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Removed the homework submission learning-links helper mixin
  by converting the reused-link fixture, post data, and assertions into module
  helpers. The focused learning-links test now inherits only from its real
  integration base. Verification:
  `uv run python manage.py test courses.tests.test_homework_submission_learning_links`,
  `uv run ruff check courses/tests/homework_submission_learning_links_helpers.py courses/tests/test_homework_submission_learning_links.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Removed the enrollment certificate bulk-update assertion
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Removed the leaderboard homework data fixture mixin by
  converting homework creation, scored/unscored submission setup, and export
  assertions into module helpers. The leaderboard homework data test now
  inherits only from the leaderboard data view base. Verification:
  `uv run python manage.py test data.tests.test_leaderboard_homework`,
  `uv run ruff check data/tests/test_leaderboard_homework.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Removed the course-criteria YAML assertion mixin and the
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed project data API test fixture, factory,
  expectation, and assertion mixins into the focused `ProjectDataAPITestBase`.
  The public project data test keeps the same setup API without a mixin
  inheritance chain. Verification:
  `uv run python manage.py test data.tests.test_project`,
  `uv run ruff check data/tests/project_base.py data/tests/test_project.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed homework data API test fixture, factory,
  expectation, and assertion mixins into the focused `HomeworkDataAPITestBase`.
  The public homework data test keeps the same setup API without a mixin
  inheritance chain. Verification:
  `uv run python manage.py test data.tests.test_homework`,
  `uv run ruff check data/tests/homework_base.py data/tests/test_homework.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Collapsed enrollment data API course, user, project, URL,
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed Datamailer membership fixture, outcome-fixture,
  upsert-assertion, and removal-assertion mixins into the focused
  `DatamailerMembershipBase`. Membership, outcome, and removal tests keep the
  same helper API without a mixin inheritance chain. Verification:
  `uv run python manage.py test courses.tests.test_datamailer_membership courses.tests.test_datamailer_membership_outcomes courses.tests.test_datamailer_membership_removals`,
  `uv run ruff check courses/tests/datamailer_membership_base.py courses/tests/test_datamailer_membership.py courses/tests/test_datamailer_membership_outcomes.py courses/tests/test_datamailer_membership_removals.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed Datamailer homework-score fixture,
  payload-assertion, submission-fixture, and send-assertion mixins into the
  focused `DatamailerHomeworkScoreTestBase`. Payload and send tests keep the
  same helper API without a mixin inheritance chain. Verification:
  `uv run python manage.py test courses.tests.test_datamailer_homework_scores courses.tests.test_datamailer_homework_score_send`,
  `uv run ruff check courses/tests/datamailer_homework_score_base.py courses/tests/test_datamailer_homework_scores.py courses/tests/test_datamailer_homework_score_send.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed Datamailer project-score fixture,
  payload-assertion, scenario-fixture, and list-send assertion mixins into the
  focused `DatamailerProjectScoreTestBase`. Project score and outcome tests
  keep the same helper API without a mixin inheritance chain. Verification:
  `uv run python manage.py test courses.tests.test_datamailer_project_scores courses.tests.test_datamailer_project_outcomes`,
  `uv run ruff check courses/tests/datamailer_project_score_base.py courses/tests/test_datamailer_project_scores.py courses/tests/test_datamailer_project_outcomes.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed Datamailer recipient-list command fixture,
  bulk-upsert assertion, import setup, registration-import assertion, and
  import-polling assertion mixins into the focused
  `DatamailerRecipientListCommandTestBase`. Recipient-list command and import
  tests keep the same helper API without a mixin inheritance chain.
  Verification:
  `uv run python manage.py test courses.tests.test_datamailer_recipient_lists courses.tests.test_datamailer_recipient_list_imports`,
  `uv run ruff check courses/tests/datamailer_recipient_lists_base.py courses/tests/test_datamailer_recipient_lists.py courses/tests/test_datamailer_recipient_list_imports.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Removed local Datamailer recipient-list audit mixins by
  converting fixture, command, member-stub, and repair assertion helpers into
  module functions. Audit test classes now inherit directly from `TestCase`.
  Verification:
  `uv run python manage.py test courses.tests.test_datamailer_recipient_list_audit`,
  `uv run ruff check courses/tests/test_datamailer_recipient_list_audit.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Removed the local project-evaluation closed-state mixin by
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed project-evaluation fixture, criteria, request,
  review-state, expectation, and assertion mixins into the focused
  `ProjectEvaluationTestBase`. The evaluation test classes stay grouped by
  subject and keep the same setup helpers without a mixin inheritance chain.
  Verification:
  `uv run python manage.py test courses.tests.test_project_eval courses.tests.test_project_eval_view`,
  `uv run ruff check courses/tests/project_eval_base.py courses/tests/test_project_eval.py courses/tests/test_project_eval_view.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Collapsed dashboard project-stat fixture, submission,
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed project-submissions fixture, request, data, and
  peer-review helper mixins into the focused
  `ProjectSubmissionsViewTestBase`. The access, display, admin-link,
  peer-review, and copy-email scenario classes keep their current grouping
  without a mixin inheritance chain. Verification:
  `uv run python manage.py test courses.tests.test_project_submissions_view`,
  `uv run ruff check courses/tests/test_project_submissions_view.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Collapsed course project-submission fixture, request,
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed project-statistics integration class-fixture,
  instance-fixture, workflow-data, assertion, and navigation mixins into the
  focused `ProjectStatisticsIntegrationTestCase`. The full workflow and
  navigation tests remain grouped in one integration case without a mixin
  inheritance chain. Verification:
  `uv run python manage.py test courses.tests.test_project_statistics_integration`,
  `uv run ruff check courses/tests/test_project_statistics_integration.py`,
  `uvx pyrefly check`, repository AST cleanup scan
...
- [x] 2026-07-02: Collapsed course leaderboard course, homework, project,
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed dashboard homework fixture, submission-stat,
  formatted-time, and difficulty mixins into the focused
  `DashboardHomeworkStatsTestBase`. The homework stats and difficulty tests
  keep the same shared setup API without a mixin inheritance chain.
  Verification:
  `uv run python manage.py test courses.tests.test_dashboard_homework_stats courses.tests.test_dashboard_homework_difficulty`,
  `uv run ruff check courses/tests/dashboard_homework_base.py courses/tests/test_dashboard_homework_stats.py courses/tests/test_dashboard_homework_difficulty.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Collapsed project assignment submission-fixture,
  ...
  `wide_positional_calls=0`, `wide_function_args=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed homework scoring-view course, question, request,
  submission-fixture, and answer-assertion mixins into the focused
  `HomeworkScoringViewBase`. The scoring-rendering and warning tests keep the
  same shared setup API without a mixin inheritance chain. Verification:
  `uv run python manage.py test courses.tests.test_homework_scoring_view courses.tests.test_homework_scoring_view_warnings`,
  `uv run ruff check courses/tests/homework_scoring_view_base.py courses/tests/test_homework_scoring_view.py courses/tests/test_homework_scoring_view_warnings.py`,
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`), and
...
- [x] 2026-07-02: Named member and row counts before assertions in shared
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named answer, question-answer, and submission counts before
  assertions in shared homework detail, homework scoring, and homework
  submissions test helpers. Verification:
  `uv run python manage.py test courses.tests.test_homework courses.tests.test_homework_submission_view courses.tests.test_homework_scoring_view courses.tests.test_homework_scoring_view_warnings courses.tests.test_homework_submissions courses.tests.test_homework_submissions_list courses.tests.test_homework_submissions_hidden_answers courses.tests.test_homework_submissions_admin_link`,
  `uv run ruff check courses/tests/homework_view_base.py courses/tests/homework_scoring_view_base.py courses/tests/homework_submissions_base.py courses/tests/test_homework.py courses/tests/test_homework_submission_view.py courses/tests/test_homework_scoring_view.py courses/tests/test_homework_scoring_view_warnings.py courses/tests/test_homework_submissions.py courses/tests/test_homework_submissions_list.py courses/tests/test_homework_submissions_hidden_answers.py courses/tests/test_homework_submissions_admin_link.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
...
- [x] 2026-07-02: Named homework/project counts and persisted start-date text
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named submission and answer counts before assertions in
  shared data API homework and project export test helpers. Verification:
  `uv run python manage.py test data.tests.test_homework data.tests.test_project`,
  `uv run ruff check data/tests/homework_base.py data/tests/project_base.py data/tests/test_homework.py data/tests/test_project.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
...
- [x] 2026-07-02: Removed the remaining multiple-inheritance test classes from
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named cadmin homework action message counts before
  assertions, keeping the existing focused test class and setup unchanged.
  Verification:
  `uv run python manage.py test cadmin.tests.test_homework_views`,
  `uv run ruff check cadmin/tests/test_homework_views.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named admin criteria form option error strings and saved
  option counts before assertions, keeping the focused form-validation test
  class unchanged. Verification:
  `uv run python manage.py test courses.tests.test_admin_criteria_form`,
  `uv run ruff check courses/tests/test_admin_criteria_form.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named course detail, dashboard homework, homework scoring,
  and homework submissions collection counts before assertions in focused view
  tests. Verification:
  `uv run python manage.py test courses.tests.test_course courses.tests.test_dashboard_homework_stats courses.tests.test_homework_scoring_view courses.tests.test_homework_submissions courses.tests.test_homework_submissions_list`,
  `uv run ruff check courses/tests/test_course.py courses/tests/test_dashboard_homework_stats.py courses/tests/test_homework_scoring_view.py courses/tests/test_homework_submissions.py courses/tests/test_homework_submissions_list.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named project-submissions page counts and dashboard
  integration homework-stat counts before assertions, keeping the existing
  focused view-test helpers unchanged. Verification:
  `uv run python manage.py test courses.tests.test_course_project_submissions courses.tests.test_dashboard_integration`,
  `uv run ruff check courses/tests/test_course_project_submissions.py courses/tests/test_dashboard_integration.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named Datamailer certificate, contact backfill,
  project-outcome, and recipient-list payload member/contact counts before
  assertions. Verification:
  `uv run python manage.py test courses.tests.test_datamailer_certificates courses.tests.test_datamailer_contact_backfill courses.tests.test_datamailer_project_outcomes courses.tests.test_datamailer_recipient_lists`,
  `uv run ruff check courses/tests/test_datamailer_certificates.py courses/tests/test_datamailer_contact_backfill.py courses/tests/test_datamailer_project_outcomes.py courses/tests/test_datamailer_recipient_lists.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
...
- [x] 2026-07-02: Named peer-review badge, project-evaluation, and project-list
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named review-criteria validation exception strings before
  assertions in the focused unit validation tests. Verification:
  `uv run python manage.py test courses.tests.test_unit_criteria_validation`,
  `uv run ruff check courses/tests/test_unit_criteria_validation.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named data export, project assignment, project submission,
  and wrapped-statistics collection counts before assertions. Verification:
  `uv run python manage.py test data.tests.test_course data.tests.test_course_criteria_yaml_edges data.tests.test_leaderboard data.tests.test_leaderboard_homework data.tests.test_leaderboard_pagination data.tests.test_leaderboard_projects courses.tests.test_unit_projects courses.tests.test_project_submissions_view courses.tests.test_wrapped_statistics courses.tests.test_wrapped_views`,
  `uv run ruff check data/tests/test_course.py data/tests/test_course_criteria_yaml_edges.py data/tests/test_leaderboard.py data/tests/test_leaderboard_homework.py data/tests/test_leaderboard_pagination.py data/tests/test_leaderboard_projects.py courses/tests/test_unit_projects.py courses/tests/test_project_submissions_view.py courses/tests/test_wrapped_statistics.py courses/tests/test_wrapped_views.py`,
  touched-file inline-assertion scan (`touched_inline_assert_calls=0`),
  `uvx pyrefly check`, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
...
- [x] 2026-07-02: Removed E2E teardown delete pass-through helpers by passing
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Removed trivial enum loop aliases from homework and project
  state-choice builders by iterating over the enum objects directly.
  Verification:
  `uv run python manage.py check`,
  `uv run ruff check courses/models/homework.py courses/models/project.py`,
  enum-alias scan (`state_choice_loop_aliases=0`), `uvx pyrefly check`,
  repository AST cleanup scan (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
...
- [x] 2026-07-02: Named remaining simple inline URL, queryset, set, float,
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named remaining record-construction values in touched
  tests and E2E settings/provisioning: created users, ISO timestamps, integer
  column flags, formatted due dates, environment-derived inbox settings, and
  default homework questions are now assigned before building dictionaries or
  argument lists. Verification:
  `uv run python manage.py test cadmin.tests.test_view_models courses.tests.test_deadline_reminder_homework courses.tests.test_load_rds_export_script`,
  `uv run ruff check cadmin/tests/test_view_models.py courses/tests/deadline_reminder_base.py courses/tests/test_load_rds_export_script.py e2e/config.py e2e/conftest.py e2e/provisioning.py`,
  `uvx pyrefly check`, record-construction scan, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`,
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
...
- [x] 2026-07-02: Removed remaining one-off `.values()` loop aliases that did
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Collapsed the single-use data API export test bases into
  their concrete homework and project export test classes, removing
  `data/tests/homework_base.py` and `data/tests/project_base.py` without
  adding inheritance or mixins. Verification:
  `uv run python manage.py test data.tests.test_homework data.tests.test_project`,
  `uv run ruff check data/tests/test_homework.py data/tests/test_project.py`,
  `uvx pyrefly check`, single-use test-base scan, repository AST cleanup scan
  (`forbidden_comprehensions=0`, `threshold_violations=0`,
  `append_constructed=0`, `wide_tuple_unpacking=0`,
  `wide_positional_calls=0`, `wide_function_args=0`,
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
...
- [x] 2026-07-02: Named remaining nested conversion, random-choice range, timing,
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Named the duplicate-slug error before returning the homework
  creation validation tuple, removing the remaining production inline tuple
  record found by the targeted scan. Verification:
  `uv run ruff check api/views/homework_create.py`,
  ...
  production inline tuple/list record scan, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
...
- [x] 2026-07-02: Removed the single-use countries config line-reader wrapper
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use leaderboard YAML serialization wrapper
  and kept `yaml.safe_dump(...)` assigned to `yaml_content` before caching.
  Verification: `uv run ruff check api/views/leaderboard_exports.py`,
  `python -m py_compile api/views/leaderboard_exports.py`,
  `uv run python manage.py test data.tests.test_leaderboard data.tests.test_leaderboard_pagination data.tests.test_leaderboard_homework data.tests.test_leaderboard_projects`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use recipient-list batch wrapper from the
  Datamailer sync management command and called the real batch builder directly
  with explicit filter-option keywords. Verification:
  `uv run ruff check courses/management/commands/sync_datamailer_recipient_lists.py`,
  `python -m py_compile courses/management/commands/sync_datamailer_recipient_lists.py`,
  `uv run python manage.py test courses.tests.test_datamailer_recipient_lists courses.tests.test_datamailer_recipient_list_imports`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use failed Datamailer send-count wrapper
  and kept the failed-send queryset/count named inside normalized send totals.
  Verification: `uv run ruff check cadmin/views/datamailer_send_audits.py`,
  `python -m py_compile cadmin/views/datamailer_send_audits.py`,
  `uv run python manage.py test cadmin.tests.test_datamailer_views`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
...
- [x] 2026-07-02: Removed the single-use email-preference success response
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use account-settings enrollment queryset
  wrapper and kept the enrollment queryset named inside the page context
  builder. Verification:
  `uv run ruff check accounts/views/account_settings.py`,
  `python -m py_compile accounts/views/account_settings.py`,
  `uv run python manage.py test accounts.tests_account_settings accounts.tests_account_timezone`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use project viewer state constructor
  wrapper and constructed `ProjectViewerState` directly in the viewer-state
  flow before authenticated-user decoration. Verification:
  `uv run ruff check courses/views/project_submission_viewer.py`,
  `python -m py_compile courses/views/project_submission_viewer.py`,
  `uv run python manage.py test courses.tests.test_project_voting courses.tests.test_project_submission_view`,
  wrapper scan for the removed helper, `uvx pyrefly check`, repository AST
  cleanup scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
...
- [x] 2026-07-02: Removed the `PeerReview.get_criteria_responses()` pass-through
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use course-criteria queryset and YAML
  serialization wrappers from the course criteria export view while keeping the
  export-data record builder. Verification:
  `uv run ruff check api/views/course_exports.py`,
  `python -m py_compile api/views/course_exports.py`,
  `uv run python manage.py test data.tests.test_course data.tests.test_course_criteria_yaml_edges data.tests.test_method_restrictions`,
  wrapper scan for removed helpers, `uvx pyrefly check`, repository AST cleanup
...
- [x] 2026-07-02: Clarified the test cleanup rule in practice: long focused test
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use mandatory-review count wrapper from
  course project badge calculation. The peer-review badge branch now names the
  queryset and count directly where the threshold decision is made. Verification:
  `uv run ruff check courses/views/course_projects.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/course_projects.py`,
  `uv run python manage.py test courses.tests.test_course_projects`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
...
- [x] 2026-07-02: Removed the cadmin project-submission review-count
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use project-results submission query
  wrapper. The authenticated results context now names the submissions queryset
  and selected submission directly before loading scores and feedback.
  Verification:
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed two single-use optional-evaluation action wrappers.
  The guarded optional-review operation now performs the evaluated-submission
  lookup and `PeerReview.objects.get_or_create(...)` directly after the
  self-review guard. Verification:
  `uv run ruff check courses/views/project_eval_actions.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/project_eval_actions.py`,
  `uv run python manage.py test courses.tests.test_project_optional_eval`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
...
- [x] 2026-07-02: Removed two single-use query wrappers from leaderboard score
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use empty course-enrollment progress
  helper. The missing-enrollment branch now returns the three-field default
  context record directly where the exception is handled. Verification:
  `uv run ruff check courses/views/course_page_context.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/course_page_context.py`,
  `uv run python manage.py test courses.tests.test_course courses.tests.test_course_certificates courses.tests.test_course_enrollment`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
...
- [x] 2026-07-02: Removed the single-use anonymous project-results context
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use anonymous project-evaluation context
  helper. The unauthenticated branch now returns the small context record
  directly in the route view, while the authenticated path still delegates to
  the student evaluation context builder. Verification:
  `uv run ruff check courses/views/project_eval.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/project_eval.py`,
  `uv run python manage.py test courses.tests.test_project_eval_view courses.tests.test_noindex`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use project-vote Ajax header helper. The
  vote response now names the `x-requested-with` header locally and branches on
  it directly, while keeping the vote application and payload helpers intact.
  Verification:
  `uv run ruff check courses/views/project_submission_votes.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/project_submission_votes.py`,
  `uv run python manage.py test courses.tests.test_project_voting`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use project-submission delete-request
  helper. The project POST handler now names the submitted action and branches
  on `"delete"` directly before delegating to the delete response. Verification:
  `uv run ruff check courses/views/project.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/project.py`,
  `uv run python manage.py test courses.tests.test_project_submission_view courses.tests.test_project_submission_invalid`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
...
- [x] 2026-07-02: Removed the single-use registration profile update guard.
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use empty assignment-statistics
  distribution helper. The short-data branch now returns the default
  min/max/average/quartile record directly where the branch is handled.
  Verification:
...
- [x] 2026-07-02: Removed the single-use project admin total-score helper. The
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use enrollment form context helper. The
  enrollment form render helper now builds the small template context directly
  before rendering. Verification:
  `uv run ruff check courses/views/course_enrollment.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/course_enrollment.py`,
  `uv run python manage.py test courses.tests.test_noindex`,
  `uv run python manage.py test courses.tests.test_course_enrollment`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
...
- [x] 2026-07-02: Removed the single-use
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use Wrapped no-data/no-activity context
  helpers. The empty wrapped-page render branches now build their small
  template contexts directly, while the richer wrapped statistics builders stay
  in `wrapped_context.py`. Also removed the redundant individual Wrapped route
  docstring so the view stays under the active-code line threshold after
  inlining. Verification:
  `uv run ruff check courses/views/wrapped.py courses/views/wrapped_context.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/wrapped.py courses/views/wrapped_context.py`,
  `uv run python manage.py test courses.tests.test_wrapped_views courses.tests.test_wrapped_statistics`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use all-project-submissions context
  helper. The list-all-project-submissions view now computes the elided page
  range and builds the render context directly in the render branch.
  Verification:
  `uv run ruff check courses/views/course_project_submissions.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/course_project_submissions.py`,
  `uv run python manage.py test courses.tests.test_course_project_submissions courses.tests.test_noindex`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use cadmin homework submission edit render
  response helper. The edit response now builds the existing edit context and
  renders the template directly after POST handling, while the substantive page
  context builder remains named. Verification:
  `uv run ruff check cadmin/views/homework_submission_edit.py docs/refactoring-plan.md`,
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use cadmin homework submission FAQ context
  helper. The edit context builder now handles GET defaults and POSTed FAQ
  values directly, removing the two-value tuple return while staying under the
  active-code threshold. Verification:
  `uv run ruff check cadmin/views/homework_submission_edit.py docs/refactoring-plan.md`,
  `python -m py_compile cadmin/views/homework_submission_edit.py`,
  `uv run python manage.py test cadmin.tests.test_homework_submission_edit_views`,
  removed-helper reference scan, touched-function line-threshold scan,
...
- [x] 2026-07-02: Removed the single-use timezone preference save helper. The
  ...
  `uv run ruff check accounts/views/timezone.py docs/refactoring-plan.md`,
  `python -m py_compile accounts/views/timezone.py`,
  `uv run python manage.py test accounts.tests_timezone accounts.tests_account_timezone`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
  scan excluding migrations (`forbidden_comprehensions=0`,
  `threshold_violations=0`, `append_constructed=0`,
  `wide_tuple_unpacking=0`, `wide_positional_calls=0`,
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use timezone-name error helper. The invalid
  timezone condition now lives directly in `_validated_timezone_value`, keeping
  the validation branch local while preserving the parse/response helpers.
  Verification:
  `uv run ruff check accounts/views/timezone.py docs/refactoring-plan.md`,
  `python -m py_compile accounts/views/timezone.py`,
  `uv run python manage.py test accounts.tests_timezone accounts.tests_account_timezone`,
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use project admin status assignment helper.
  The project submission admin update now assigns `reviewed_enough_peers` and
  `passed` directly in the transaction before recalculating and saving the
  ...
  `wide_function_args=0`, `nested_wide_for_unpacking=0`,
  `range_len_loops=0`), and `git diff --check`.
- [x] 2026-07-02: Removed the single-use homework admin submission-field
  assignment helper. The homework submission admin update now assigns learning
  in public links and FAQ contribution URL directly before rescoring and saving
  the admin score overrides. Verification:
  `uv run ruff check cadmin/services.py docs/refactoring-plan.md`,
  `python -m py_compile cadmin/services.py`,
  `uv run python manage.py test cadmin.tests.test_homework_submission_edit_views`,
  removed-helper reference scan, `uvx pyrefly check`, repository AST cleanup
...
- [x] 2026-07-02: Removed the single-use project FAQ contribution URL field
  ...
  `nested_wide_for_unpacking=0`, `range_len_loops=0`), and
  `git diff --check`.
- [x] 2026-07-02: Removed the single-use project time-spent field helper. The
  time-spent guard and parsed assignment now live in
  `apply_project_submission_optional_post_fields`, while learning-link cleanup
  remains a named helper because it owns validation and normalization.
  Verification:
  `uv run ruff check courses/views/project_submission_edit.py docs/refactoring-plan.md`,
  `python -m py_compile courses/views/project_submission_edit.py`,
  `uv run python manage.py test courses.tests.test_project_submission_view courses.tests.test_project_view courses.tests.test_project_submission_confirmation`,
