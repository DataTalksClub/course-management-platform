...
class CadminViewTests(TestCase):
    ...
    def test_homework_submission_edit_triggers_leaderboard_update(self):
        ...
        )  # Score from the corrected answer
